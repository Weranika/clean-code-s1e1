...
var incompleteTaskHolder=document.getElementById("todo__container");//ul of #todo__container
var completedTasksHolder=document.getElementById("completed-tasks__container");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButton.className="input-form__button";
...
//Mark task as incomplete.
    ...
    //Append the task list item to the #todo__container.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
